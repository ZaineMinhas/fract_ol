...
/*   Updated: 2021/07/10 17:25:06 by zminhas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	mandelbrot_calc(t_calc *c)
{
...
void	mandelbrot(t_fract *var)
{
	...
	while (++c.x < var->param->screen_x)
	{
		...
		{
			c.c_r = c.x / var->param->zoom_x + var->param->x1;
			c.c_i = c.y / var->param->zoom_y + var->param->y1;
			c.z_r = 0;
			c.z_i = 0;
			c.i = -1;
